...
function PropertyList() {
  ...
  console.log('propertyList',data,error);
  const images = [
  ...
  return (
    <div className='pList'>
      {
        loading ? 'Property List is Loading' :
          <>
            {data && images.map((img,i) => (
              <div className='pListItem' key={i + 10}>
                <img className='pListImg' src={img} alt='not available'></img>
